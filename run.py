...
def main_menu():
    ...
    print("Please find below the option to make your appointment or edit/cancel an existing one.\n")
...
def date_choice():
    ...
    if match_date:
        ...
        print("Did you book a weekday and used the correct format: YYYY/MM/DD)?")
...
def find_booking():
    ...
    print("Your unique booking ID will have been provided at the time of your booking.")
    ...
    if insert_booking_id == "r":
        #clear_screen()
        print("OK, you chose to cancel. let us bring you back to the main menu.")
        ...
        if existing_booking != []:
            ...
            print("Your unique booking ID will have been provided at the time of your booking.")
            print("Your booking ID consists of numbers only.\n")
            ...
            if try_again == "y":
                ...
                print("From here you can try again, exit the program.")
            ...
            if client_confirmation == "y":
                ...
                while True:
                    ...
                    if diff_book_id == "y":
                        ...
                        print("\nSorry, we did not get that. Please ensure that you use the suggested y or n format.")
...
def update_booking(correct_booking):
    ...
    print("print correct booking data in update booking function", correct_booking)
    print("print value booking ID data in update booking function", value_booking_id)
    #clear_screen()
    ...
    if change_date == "y":
        ...
        print("printout correct booking before it goes in", correct_booking)
        print(type(correct_booking))
        print("printout value booking iD before it goes in", value_booking_id)
        print(type(value_booking_id))
        ...
        #clear_screen()
        print("Editing your booking has been cancelled. Bringing you back to the main menu.")
        main_menu()
    else:
        print("Sorry, we did not understand what you meant")
        try_again = input("Would you like to try again? (y/n): ")
